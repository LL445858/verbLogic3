...
def main():
    ...
    # 文件路径
    transition_matrix_path = r"Y:\Project\Python\VerbLogic\data\excel\动词类别转移概率_部分.xlsx"
    initial_vector_path = r"Y:\Project\Python\VerbLogic\data\excel\动词类别频次_部分.xlsx"
    output_path = r"Y:\Project\Python\VerbLogic\data\excel\PageRank_部分.xlsx"
