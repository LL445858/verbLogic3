...
if __name__ == "__main__":
    input_matrix = r"Y:\Project\Python\VerbLogic\data\excel\动词类别转移概率_部分_非马尔可夫.xlsx"
    pagerank_file = r"Y:\Project\Python\VerbLogic\data\excel\PageRank_部分.xlsx"
    threshold = 0
    top_k = 15
    out_prefix = r"Y:\Project\Python\VerbLogic\data\excel\主路径_加权_部分"
